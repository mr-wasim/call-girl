...
export default function Footer() {
  ...
  return (
    <footer className="relative" style={{ background: "var(--footer-bg, #1f1f1f)", color: "var(--footer-text, #d1d5db)", marginTop: 56 }}>
      ...
      <div className="relative z-10 container-w px-6 py-8">
        <div className="flex flex-wrap gap-x-6 gap-y-2 text-[14px] mb-6">
          <Link href="#" className="hover:underline" style={{ color: accent }}>Forums</Link>
          <Link href="#" className="hover:underline" style={{ color: accent }}>About</Link>
          <Link href="#" className="hover:underline" style={{ color: accent }}>Blog</Link>
          <Link href="#" className="hover:underline" style={{ color: accent }}>Advertise Escort Services</Link>
          <Link href="#" className="hover:underline" style={{ color: accent }}>Help for Advertisers</Link>
          <Link href="#" className="hover:underline" style={{ color: accent }}>Guide to seeing an escort</Link>
        ...
        <div className="text-[12.5px]" style={{ color: "var(--footer-muted, #9ca3af)" }}>
          ...
          <Link href="#" className="hover:underline" style={{ color: accent }}>Terms of Use</Link>
          &nbsp;|&nbsp;
          <Link href="#" className="hover:underline" style={{ color: accent }}>Privacy Policy</Link>
          &nbsp;|&nbsp;
          <Link href="#" className="hover:underline" style={{ color: accent }}>GDPR</Link>
          &nbsp;|&nbsp;
          <Link href="#" className="hover:underline" style={{ color: accent }}>Contact Us</Link>
        </div>
      </div>
    </footer>
  )
